...
from module import ttm  # input b c t h w ,out : out [b,clss] mem[b,size,dim]
import torch
model = ttm().cuda()
mem = None
...
loger = SummaryWriter(
    r"F:\TTM_CODE\modify_ttm\board\_test_no_pos_rate_0.4_add_trained_memory_loss_another")
