...
from model.ttm_basic_network import ttm_encoder
...
# loger=SummaryWriter("E:\\CHDLearning\\TTM\\DataRecord\\TrainLoss\\TrainLoss_TTM_ReadPosition_Mem1024_token16")
model=ttm_encoder().cuda()
...
for i in range(1000):
    for x,y in tqdm.tqdm(train_loader):
        ...
        if flag % 100 == 0:
            ...
            print(save_loss)
            losses=[]
            # torch.save({"model":model.state_dict(),"memory":save_memory},f"E:\\CHDLearning\\TTM\DataRecord\\Pth\\TTM_ReadPosition_Mem1024_token16\\loss_{flag}.pth")
        flag += 1 